...
\begin{figure}[!ht]
\begin{center}
  \subfloat[Price]{\includegraphics[width = 0.5\textwidth]
  {figuretable/container_freight_rate_each_route.png}}
  \subfloat[Quantity]{\includegraphics[width = 0.5\textwidth]
...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[Industry-year-level variables (1966-1998)]{\input{figuretable/summary_statistics_of_industry_before_1998}}
