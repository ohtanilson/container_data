...
Review1971_1998 <-
  readxl::read_excel(
    "input/Review1971_1998.xlsx") %>%
  tidyr::tibble()
Lloyd_shipping_economist_1980_1998 <-
  readxl::read_excel(
    "input/Lloyd_shipping_economist_1980_1998.xlsx") %>%
  tidyr::tibble()
Lloyd_shipping_economist_1980_1998 <-
  Lloyd_shipping_economist_1980_1998 %>% 
  dplyr::mutate(
...
Lloyd_shipping_economist_1980_1998_newbuilding <-
  ...
  dplyr::filter(
    type == 
      "newbuilding_price_per_dwt_1600teu_fullcon"|
      type == 
      "newbuilding_price_per_dwt_2500teu_fullcon") %>% 
  dplyr::mutate(
    price_per_TEU =
      ifelse(
        type == 
