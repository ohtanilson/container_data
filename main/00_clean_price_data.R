...
freight_rate_global_container_markets <-
  readxl::read_excel("input/freight_rate_global_container_markets.xlsx") %>%
  tidyr::tibble()
freight_rate_main_routes_review_of_maritime_transport <-
  readxl::read_excel("input/freight_rate_main_routes_review_of_maritime_transport.xlsx") %>%
  tidyr::tibble()
freight_rate_global_review_of_maritime_transport <-
  readxl::read_excel("input/freight_rate_global_review_of_maritime_transport.xlsx") %>%
  tidyr::tibble()
freight_rate_issues_of_our_ocean_shipping <-
  readxl::read_excel("input/freight_rate_issues_of_our_ocean_shipping.xlsx") %>%
  tidyr::tibble()
freight_revenue_current_status_of_marine_transportation <-
  readxl::read_excel("input/freight_revenue_current_status_of_marine_transportation.xlsx") %>%
  tidyr::tibble()
...
traffic_amount_current_status_of_marine_transportation <-
  readxl::read_excel("input/traffic_amount_current_status_of_marine_transportation.xlsx") %>%
  tidyr::tibble()
...
conversion_rate_in_1965 <-
  as.numeric(freight_rate_global_review_of_maritime_transport_1965[11]/
               freight_rate_global_review_of_maritime_transport_1965[12])
conversion_rate_in_1980 <-
  as.numeric(freight_rate_global_review_of_maritime_transport_1980[10]/
               freight_rate_global_review_of_maritime_transport_1980[11])
conversion_rate_in_1985 <-
  as.numeric(freight_rate_global_review_of_maritime_transport_1985[9]/
               freight_rate_global_review_of_maritime_transport_1985[10])
conversion_rate_in_1990 <-
  as.numeric(freight_rate_global_review_of_maritime_transport_1990[8]/
               freight_rate_global_review_of_maritime_transport_1990[9])
conversion_rate_in_1995 <-
  as.numeric(freight_rate_global_review_of_maritime_transport_1995[7]/
               freight_rate_global_review_of_maritime_transport_1995[8])
freight_rate_global_review_of_maritime_transport <-
  freight_rate_global_review_of_maritime_transport %>%
  dplyr::group_by(year) %>%
  dplyr::mutate(global_liner_freight_rate =
                  dplyr::case_when(
                    year < 1968 ~
                      `global rate(1959=100)`*conversion_rate_in_1965*
                      conversion_rate_in_1980*conversion_rate_in_1985*
                      conversion_rate_in_1990*conversion_rate_in_1995,
                    year >= 1968 && year < 1983 ~
                      `global rate(1965=100)`*conversion_rate_in_1980*
                      conversion_rate_in_1985*conversion_rate_in_1990*
                      conversion_rate_in_1995,
                    year >= 1983 && year < 1990 ~
                      `global rate(1980=100)`*conversion_rate_in_1985*
                      conversion_rate_in_1990*conversion_rate_in_1995,
                    year >= 1990 && year < 1994 ~
                      `global rate(1985=100)`*conversion_rate_in_1990*
                      conversion_rate_in_1995,
                    year >= 1994 && year < 1997 ~
                      `global rate(1990=100)`*conversion_rate_in_1995,
                    year >= 1997 ~
...
merged_freight_rate_global_review_of_maritime_transport <-
  freight_rate_global_review_of_maritime_transport %>%
  dplyr::left_join(container_freight_rate,
                   by = c("year" = "year")) %>%
  tidyr::gather("route",
                "value",
                -year) %>%
  dplyr::mutate(route =
                  ifelse(route == "global_liner_freight_rate",
                         "liner freight rate",
...
merged_freight_rate_global_review_of_maritime_transport_deflated <-
  ...
  dplyr::select(-global_liner_freight_rate,
                -merged_container_freight_rate,
                -cpi_based_on_1995) %>%
  tidyr::gather("route",
                "value",
...
d <-
  rbind(merged_freight_rate_global_review_of_maritime_transport,
        merged_freight_rate_global_review_of_maritime_transport_deflated)
d <-
  merged_freight_rate_global_review_of_maritime_transport_deflated
x <-
...
freight_rate_main_routes_review_of_maritime_transport <-
  freight_rate_main_routes_review_of_maritime_transport %>%
  dplyr::group_by(year) %>%
  dplyr::summarise(transpacific_eastbound =
...
freight_rate_main_routes_review_of_maritime_transport_year1994 <-
  ...
  dplyr::summarise(mean(transpacific_eastbound))
...
conversion_ratio_from_FEU_to_TEU <-
  as.numeric(freight_rate_main_routes_review_of_maritime_transport_year1994/
               freight_rate_global_container_markets_year1994)
freight_rate_global_container_markets <-
  freight_rate_global_container_markets %>%
  dplyr::mutate(transpacific_eastbound =
                  transpacific_eastbound*conversion_ratio_from_FEU_to_TEU,
                transpacific_westbound =
                  transpacific_westbound*conversion_ratio_from_FEU_to_TEU,
                transatlantic_eastbound =
                  transatlantic_eastbound*conversion_ratio_from_FEU_to_TEU,
                transatlantic_westbound =
                  transatlantic_westbound*conversion_ratio_from_FEU_to_TEU,
                europe_to_asia =
                  europe_to_asia*conversion_ratio_from_FEU_to_TEU,
                asia_to_europe =
                  asia_to_europe*conversion_ratio_from_FEU_to_TEU) %>%
  dplyr::left_join(freight_rate_global_review_of_maritime_transport,
                   by = c("year" = "year"))
conversion_ratio_from_liner_freight_rate_to_route_level_1990 <-
  freight_rate_global_container_markets %>%
  dplyr::filter(year == 1990) %>%
  dplyr::mutate(europe_to_asia_conversion_rate =
                  europe_to_asia/global_liner_freight_rate,
                asia_to_europe_conversion_rate =
                  asia_to_europe/global_liner_freight_rate)
conversion_ratio_from_liner_freight_rate_to_route_level_1978 <-
  freight_rate_global_container_markets %>%
  dplyr::filter(year == 1978) %>%
  dplyr::mutate(transatlantic_eastbound_conversion_rate =
                  transatlantic_eastbound/global_liner_freight_rate,
                transatlantic_westbound_conversion_rate =
                  transatlantic_westbound/global_liner_freight_rate)
conversion_ratio_from_liner_freight_rate_to_route_level_1990 <-
  freight_rate_global_container_markets %>%
  dplyr::filter(year == 1990) %>%
  dplyr::mutate(europe_to_asia_conversion_rate =
...
freight_rate_issues_of_our_ocean_shipping_1970 <-
  ...
  dplyr::left_join(freight_rate_global_review_of_maritime_transport,
                   by = c("year" = "year")) %>%
  dplyr::mutate(
    conversion_rate_1970 = `asia_to_europe(constant_1979)`/
      global_liner_freight_rate
  )
...
freight_rate_issues_of_our_ocean_shipping_converted <-
  freight_rate_issues_of_our_ocean_shipping %>%
  dplyr::filter(is.na(`transpacific(constant_1979)`) == 0) %>%
  dplyr::select(year,
                `transpacific(constant_1979)`,
                `transatlantic(constant_1979)`,
                `asia_to_europe(constant_1979)`) %>%
  dplyr::mutate(`asia_to_europe(constant_1979)` =
                  ifelse(is.na(`asia_to_europe(constant_1979)`) == 1,
                         `transpacific(constant_1979)`,
                         `asia_to_europe(constant_1979)`)) %>%
  dplyr::group_by(year) %>%
  # take the mean of three main types of cargo.
  dplyr::summarise(transpacific =
  ...
  dplyr::mutate(transpacific =
                  (transpacific/100)*transpacific_distance_mile*
                  conversion_ratio_tons_to_TEU,
                transatlantic =
                  (transatlantic/100)*transatlantic_distance_mile*
                  conversion_ratio_tons_to_TEU,
                asia_to_europe =
                  (asia_to_europe/100)*asia_to_europe_distance_mile*
                  conversion_ratio_tons_to_TEU)
...
## impute missing asia_to_europe and transatlantic_eastbound ----
# using liner freight rate and yearly level proportional rates
# freight_rate_global_container_markets <-
#   freight_rate_global_container_markets %>%
#   dplyr::mutate(transatlantic_eastbound =
#                   ifelse(is.na(transatlantic_eastbound) == 1,
#                          global_liner_freight_rate*
#                            conversion_ratio_from_liner_freight_rate_to_route_level_1978$transatlantic_eastbound_conversion_rate,
#                          transatlantic_eastbound),
#                 # europe_to_asia =
#                 #   ifelse(is.na(europe_to_asia) == 1,
#                 #          global_liner_freight_rate*
#                 #            conversion_ratio_from_liner_freight_rate_to_route_level_1990$europe_to_asia_conversion_rate,
#                 #          europe_to_asia),
#                 asia_to_europe =
#                   ifelse(is.na(asia_to_europe) == 1,
#                          global_liner_freight_rate*
#                            conversion_ratio_from_liner_freight_rate_to_route_level_1990$asia_to_europe_conversion_rate,
#                          asia_to_europe))
...
conversion_ratio_aggregate_to_each_bound <-
  freight_rate_global_container_markets_year1976 %>%
  dplyr::mutate(transpacific_eastbound_rate =
                  transpacific_eastbound/
...
d_1973_1994_at_1976 <-
  ...
  dplyr::filter(year == 1976)
d_1965_1994 <-
  rbind(route_level_freight_rate_issues_of_our_ocean_shipping[1:8,1:7],
        d_1973_1994) %>%
  dplyr::distinct(year,
                  .keep_all = TRUE) %>%
  dplyr::arrange(year) 
...
d_1965_1994[8:13,4] <-
  FreqProf::approxm(d_1965_1994[8:13,4],
                    n = 6)
d_1965_1994[8:13,5] <-
  FreqProf::approxm(d_1965_1994[8:13,5],
                    n = 6)
d_1965_1994[12:14,6] <-
  FreqProf::approxm(d_1965_1994[12:14,6],
                    n = 3)
d_1965_1994[12:14,7] <-
  FreqProf::approxm(d_1965_1994[12:14,7],
                    n = 3)
...
convertion_rate_1994 <- 
  ...
  d_1965_1994[30,2:7]
d_1965_1994[,2] <- 
  d_1965_1994[,2]*as.numeric(convertion_rate_1994[1])
d_1965_1994[,3] <- 
  d_1965_1994[,3]*as.numeric(convertion_rate_1994[2])
d_1965_1994[,4] <- 
  d_1965_1994[,4]*as.numeric(convertion_rate_1994[3])
d_1965_1994[,5] <- 
  d_1965_1994[,5]*as.numeric(convertion_rate_1994[4])
d_1965_1994[,6] <- 
  d_1965_1994[,6]*as.numeric(convertion_rate_1994[5])
d_1965_1994[,7] <- 
  d_1965_1994[,7]*as.numeric(convertion_rate_1994[6])
d_1965_1994 <-
  d_1965_1994 %>% 
...
d_1965_2009_nondeflated <-
  ...
  tidyr::gather(key = "route",
                value = "value",
                -year)
x <- ggplot(d_1965_2009_nondeflated,
            aes(x = year, y = value)) +
  geom_line(aes(color = route), alpha = 0.6) +
  geom_point(aes(shape = route, color = route)) +
...
d_1965_2009 <-
  ...
  dplyr::left_join(cpi_1965_2010_based_on_1995,
                   by = c("year" = "year")) %>%
  dplyr::mutate(
    transpacific_eastbound = transpacific_eastbound/
      cpi_based_on_1995,
    transatlantic_eastbound = transatlantic_eastbound/
      cpi_based_on_1995,
    transpacific_westbound = transpacific_westbound/
      cpi_based_on_1995,
    transatlantic_westbound = transatlantic_westbound/
      cpi_based_on_1995,
    europe_to_asia = europe_to_asia/
      cpi_based_on_1995,
    asia_to_europe = asia_to_europe/
...
temp_merged_freight_rate_global_review_of_maritime_transport_deflated <-
  merged_freight_rate_global_review_of_maritime_transport_deflated %>%
  dplyr::rename(route2 = route,
                liner_freight_rate = value) %>%
  dplyr::filter(route2 != "container freight rate (CPI adjusted to 1995)")
d_1965_2009 <-
  d_1965_2009 %>%
  dplyr::left_join(
    temp_merged_freight_rate_global_review_of_maritime_transport_deflated,
...
container_freight_rate_each_route <-
  ...
  dplyr::rename(route = route,
                liner_freight_rate_CPI_adjusted_1995 = route2)
# drop the pre-period before global containerization
container_freight_rate_each_route <-
  container_freight_rate_each_route %>% 
  dplyr::filter((route == "transpacific_eastbound"&year>=1967)|
...
Data_Extract_From_World_Development_Indicators <-
  readxl::read_excel("input/Data_Extract_From_World_Development_Indicators.xlsx") %>%
  tidyr::tibble()
GDP_table <-
...
GDP_table_eastbound <-
  ...
  dplyr::mutate(route =
                  dplyr::case_when(
                    route == "east_asia" ~ "europe_to_asia",
                    route == "united_state" ~ "transpacific_eastbound",
                    route == "euro_area" ~ "transatlantic_eastbound"
                    ))
quantity_eastbound <-
  d_1965_2009 %>%
  dplyr::select(year,
  ...
  dplyr::left_join(GDP_table_eastbound,
                   by = c("year" = "year",
                          "route" = "route"))
GDP_table_westbound <-
  GDP_table %>%
  dplyr::mutate(route =
                  dplyr::case_when(
                    route == "east_asia" ~ "transpacific_westbound",
                    route == "united_state" ~ "transatlantic_westbound",
                    route == "euro_area" ~ "asia_to_europe"
                  ))
quantity_westbound <-
  d_1965_2009 %>%
  dplyr::select(year,
  ...
  dplyr::left_join(GDP_table_westbound,
                   by = c("year" = "year",
                          "route" = "route"))

GDP_of_destination_route_level <-
  rbind(quantity_eastbound,
        quantity_westbound) %>%
  dplyr::arrange(year) %>%
  dplyr::rename(route = route,
                GDP = value)
...
crude_oil_prices <-
  ...
  dplyr::left_join(cpi_1965_2010_based_on_1995,
                   by = c("year" = "year")) %>%
  dplyr::mutate(crude_oil_prices_cpi_adjusted_1995 =
                  crude_oil_price/cpi_based_on_1995)
  
ggplot(crude_oil_prices,
       aes(x = year,
...
crude_oil_prices_route_level <-
  ...
  dplyr::select(year,
                route) %>%
  dplyr::left_join(crude_oil_prices,
                   by = c("year" = "year")) %>%
  dplyr::mutate(crude_oil_price_weighted_mile =
                  dplyr::case_when(
                    route == "transpacific_westbound" ~
                      crude_oil_prices_cpi_adjusted_1995*transpacific_distance_mile/
                      transpacific_distance_mile,
                    route == "transatlantic_westbound" ~
                      crude_oil_prices_cpi_adjusted_1995*transatlantic_distance_mile/
                      transpacific_distance_mile,
                    route == "asia_to_europe" ~
                      crude_oil_prices_cpi_adjusted_1995*asia_to_europe_distance_mile/
                      transpacific_distance_mile,
...
saveRDS(container_freight_rate_each_route,
        file = "cleaned/container_freight_rate_each_route.rds")
saveRDS(d_1965_1994_price_rawdata,
        file = "cleaned/d_1965_1994_price_rawdata.rds")
saveRDS(GDP_of_destination_route_level,
        file = "cleaned/GDP_of_destination_route_level.rds")

saveRDS(crude_oil_prices_route_level,
        file = "cleaned/crude_oil_prices_route_level.rds")
